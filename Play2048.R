# Play 2048 now using R!
#
#  use install.packages("...") for any package which fails to load
#  change the browser to the one of your choice in the remoteDriver function
#  run the program, it starts the server and then sit back and enjoy
#
#  Credits: Mark T. Patterson from R-Bloggers
#  Check out more awesome articles here: http://www.r-bloggers.com/author/mark-t-patterson/
#
#
